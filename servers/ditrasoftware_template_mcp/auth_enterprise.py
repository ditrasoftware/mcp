...
from .rest_client import DitraSoftwareAuth
...
def audit_log(event: AuditEvent, settings: DitraSoftwareSettings) -> None:
...
def should_refresh_token(token_info: TokenInfo, settings: DitraSoftwareSettings) -> bool:
...
def is_token_revoked(token: str, settings: DitraSoftwareSettings) -> bool:
...
def has_scope(token_scopes: list[str] | None, required_scope: str, settings: DitraSoftwareSettings) -> bool:
...
def requires_mfa(settings: DitraSoftwareSettings, risk_score: float | None = None) -> bool:
...
def extract_user_identity(auth: DitraSoftwareAuth, settings: DitraSoftwareSettings) -> dict[str, Any]:
